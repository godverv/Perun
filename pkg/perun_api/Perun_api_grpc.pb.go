...
func (c *perunAPIClient) Version(ctx context.Context, in *Version_Request, opts ...grpc.CallOption) (*Version_Response, error) {
	...
	err := c.cc.Invoke(ctx, PerunAPI_Version_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *perunAPIClient) ConnectVelez(ctx context.Context, in *ConnectVelez_Request, opts ...grpc.CallOption) (*ConnectVelez_Response, error) {
	...
	err := c.cc.Invoke(ctx, PerunAPI_ConnectVelez_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *perunAPIClient) ListNodes(ctx context.Context, in *ListNodes_Request, opts ...grpc.CallOption) (*ListNodes_Response, error) {
	...
	err := c.cc.Invoke(ctx, PerunAPI_ListNodes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *perunAPIClient) RunService(ctx context.Context, in *RunService_Request, opts ...grpc.CallOption) (*RunService_Response, error) {
	...
	err := c.cc.Invoke(ctx, PerunAPI_RunService_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
